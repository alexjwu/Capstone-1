...
WineList <- WineList %>% mutate(India = ifelse(region == "India", 1, ifelse(is.na(Type), 0, 0)))
WineList <- WineList %>% mutate(CentralAsia = ifelse(region == "Central Asia", 1, ifelse(is.na(Type), 0, 0)))
...
WineList <- WineList %>% mutate(CentralAsia = ifelse(region == "Central Asia", 1, ifelse(is.na(Type), 0, 0)))
WineList <- WineList %>% mutate(EastAsia = ifelse(region == "East Asia", 1, ifelse(is.na(Type), 0, 0)))
